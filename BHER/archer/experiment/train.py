...
import BHER.archer.experiment.config as config
...
@click.option('--logdir', type=str, default='../../result/archer/FetchPickAndPlace-1', help='the path to where logs and policy pickles should go. If not specified, creates a folder in /tmp/')
...
@click.option('--replay_strategy', type=str, default='archer-10-20', help='the HER replay strategy to be used. "future" uses HER, "none" disables HER.')
