...
from BHER.mep.util import (
    import_function, store_args, flatten_grads, transitions_in_episode_batch)
from BHER.mep.normalizer import Normalizer
from BHER.mep.replay_buffer import ReplayBuffer, ReplayBufferEntropy, PrioritizedReplayBuffer
from BHER.common.mpi_adam import MpiAdam
import BHER.common.tf_util as U
from BHER.common.schedules import LinearSchedule, PiecewiseSchedule
import json
...
class DDPG(object):
    ...
    def __init__(self, input_dims, buffer_size, hidden, layers, network_class, polyak, batch_size,
        ...
        if self.prioritization == 'entropy':
            self.buffer = ReplayBufferEntropy(buffer_shapes, buffer_size, self.T, self.sample_transitions, 
    ...
    def store_episode(self, episode_batch, dump_buffer, rank_method, epoch, update_stats=True):
        """
