...
from BHER.mep.ddpg import DDPG
from BHER.mep.her import make_sample_her_transitions, \
                              make_sample_her_transitions_entropy, \
                              make_sample_her_transitions_prioritized_replay

from BHER.mep.util import wrap_pendulum_obs
...
DEFAULT_PARAMS = {
    ...
    'network_class': 'BHER.her.actor_critic:ActorCritic',
    ...
    # HER
    'replay_strategy': 'mep',  # supported modes: future, none
...
def compute_reward(achieved_goal, desired_goal, info):
    # Compute distance between desired goal and the achieved goal.
