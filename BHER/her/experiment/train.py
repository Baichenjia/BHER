...
import BHER.her.experiment.config as config
...
@click.option('--logdir', type=str, default='../../result/her/FetchPickAndPlace-3', help='the path to where logs and policy pickles should go. If not specified, creates a folder in /tmp/')
